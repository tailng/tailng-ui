...
function componentTs(
  ...
  return [
    ...
    '  }',
    '',
    '  protected applyNodeChanges(request: TngFlowNodePropertyChangeRequest<unknown>): void {',
...
function plainCssMarkup(scenario: FlowExecutionViewerScenario): string {
  return [
    ...
    '  </header>',
    '',
    '  <section class="execution-viewer-example__block" aria-label="Composite viewer">',
    ...
    '  </section>',
    '',
    '  <section class="execution-viewer-example__block" aria-label="Split components">',
    '    <h3>Split graph and node properties</h3>',
    '    <div class="execution-viewer-example__split">',
    '      <tng-flow-execution-graph',
    `        flowId="${scenario.id}-plain-execution-graph"`,
    `        ariaLabel="${scenario.title} execution graph"`,
    '        class="execution-viewer-example__graph"',
    '        [definition]="definition()"',
    '        [snapshot]="snapshot"',
    '        [selection]="selection()"',
    '        [inspectedNodeId]="inspectedNodeId()"',
    ...
    '        class="execution-viewer-example__properties"',
    '        [definition]="definition()"',
    '        [inspectedNodeId]="inspectedNodeId()"',
...
function tailwindMarkup(scenario: FlowExecutionViewerScenario): string {
  return [
    ...
    '  </header>',
    '',
    '  <section aria-label="Composite viewer" class="grid gap-2">',
    '    <h3 class="m-0 text-sm font-semibold text-tng-fg-primary">Composite viewer</h3>',
    '    <tng-flow-execution-viewer',
    ...
    '  </section>',
    '',
    '  <section aria-label="Split components" class="mt-4 grid gap-2">',
    '    <h3 class="m-0 text-sm font-semibold text-tng-fg-primary">',
    '      Split graph and node properties',
    '    </h3>',
    '    <div class="grid min-h-[24rem] grid-cols-[minmax(0,1fr)_minmax(16rem,22rem)] overflow-hidden rounded-lg border border-tng-border-subtle max-lg:grid-cols-1">',
    '      <tng-flow-execution-graph',
    `        flowId="${scenario.id}-tailwind-execution-graph"`,
    `        ariaLabel="${scenario.title} execution graph"`,
    '        class="block min-h-[24rem]"',
    '        [definition]="definition()"',
    '        [snapshot]="snapshot"',
    '        [selection]="selection()"',
    '        [inspectedNodeId]="inspectedNodeId()"',
    ...
    '',
    '      <tng-flow-node-properties',
    '        class="block min-h-[24rem] border-l border-tng-border-subtle max-lg:border-l-0 max-lg:border-t"',
    '        [definition]="definition()"',
    '        [inspectedNodeId]="inspectedNodeId()"',
    '        (nodeChangeRequested)="applyNodeChanges($event)"',
    '      />',
...
function plainCss(): string {
  return [
    ...
    '}',
    '',
    '.execution-viewer-example__block {',
    '  display: grid;',
    '  gap: 0.5rem;',
    '}',
    '',
    '.execution-viewer-example__block + .execution-viewer-example__block {',
    '  margin-top: 1rem;',
    '}',
    '',
    '.execution-viewer-example__block h3 {',
    '  color: var(--tng-semantic-foreground-primary);',
    '  font-size: 0.9rem;',
    '  margin: 0;',
    '}',
    ...
    '}',
    '',
    '.execution-viewer-example__split {',
    '  display: grid;',
    ...
    '}',
    '',
    '.execution-viewer-example__graph,',
    '.execution-viewer-example__properties {',
    '  display: block;',
    '  min-height: 24rem;',
    '}',
    '',
